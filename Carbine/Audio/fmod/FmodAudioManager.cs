    ...
    internal class FmodAudioManager : AudioManager
    {
        ...
        public FmodAudioManager()
        {
            ...
            else
            {
                ...
                Console.WriteLine("Audio driver name: {0}", (object)str);
        ...
        public override CarbineSound Use(string filename, AudioType type, [CallerLineNumber] int i = 0, [CallerMemberName] string member = "")
        {
            ...
            if (!this.sounds.ContainsKey(hashCode))
            {
                ...
                this.sounds.Add(hashCode, (CarbineSound)fmodSound);
            }
            else
            {
            ...
            return (CarbineSound)fmodSound;
        }

        public override void Unuse(CarbineSound sound)
        {
            int key1 = 0;
            CarbineSound carbineSound = (CarbineSound)null;

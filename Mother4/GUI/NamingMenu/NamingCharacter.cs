...
namespace Mother4.GUI.NamingMenu
{
	internal class NamingCharacter : Renderable
	{
		...
		public NamingCharacter(CharacterType initialCharacter, int depth)
		{
			...
			this.depth = depth;
			this.shadowGraphic = new Graphic(Paths.GRAPHICS + "shadow.png", this.position, new IntRect(0, 0, 15, 4), new Vector2f(7f, 1f), this.depth - 1);
		...
		private void graphic_OnAnimationComplete(Graphic graphic)
		{
			this.timer = 0;
